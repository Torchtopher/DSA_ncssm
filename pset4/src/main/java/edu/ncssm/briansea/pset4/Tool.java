...
public interface Tool {
     ...
     * @param m the mouse event caused by the user; includes keyboard modifiers
     * @return a new graphic caused by the event or null if nothing new was created
     ...
     * @return      * @return a new graphic caused by the event or null if nothing new was created
